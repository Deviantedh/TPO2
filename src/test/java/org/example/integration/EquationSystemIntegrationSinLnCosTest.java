...
public class EquationSystemIntegrationSinLnCosTest {
    ...
    // Проверяет левую ветку после подключения sin, ln и cos.
    @Test
    public void testLeftBranchWithSinLnCos() {
        ...
        BigDecimal tanVal = new BigDecimal("2.185039863261519");
    ...
    // Проверяет правую ветку после подключения sin, ln и cos.
    @Test
    public void testRightBranchWithSinLnCos() {
        BigDecimal x = new BigDecimal("2");
